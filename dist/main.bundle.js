...
/***/ function(module, exports, __webpack_require__) {
		...
		_createClass(AddTodo, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement('input', { type: 'text', ref: 'addTodo' }),
					_react2.default.createElement(
						'button',
						{ onClick: function onClick(e) {
								return _this2.addTodoHandler(e);
							} },
						'addTodo'
					)
				);
			...
			key: 'addTodoHandler',
			value: function addTodoHandler(e) {
				var val = (0, _reactDom.findDOMNode)(this.refs.addTodo).value;
	...
	AddTodo.propTypes = {
		addTodoHandler: _react.PropTypes.func.isRequired
	};
	...
	var TodoItem = function (_Component2) {
		...
		_createClass(TodoItem, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'li',
					{ onClick: this.props.onClick, style: { textDecoration: this.props.done == true ? 'line-through' : 'none' } },
					this.props.title,
					_react2.default.createElement(
						'button',
			...
			value: function render() {
				...
				switch (filterState) {
					case 'show_all':
						...
						break;
					case 'show_finished':
						filterData = todoList.filter(function (t) {
							return t.done;
						});
						break;
					case 'show_active':
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						{ href: 'javascript:void(0);', onClick: function onClick() {
								return _this7.props.onClick('show_all');
							} },
						'All '
					),
					_react2.default.createElement(
						'a',
						{ href: 'javascript:void(0);', onClick: function onClick() {
								return _this7.props.onClick('show_finished');
							} },
						'Finished '
					),
					_react2.default.createElement(
						'a',
						{ href: 'javascript:void(0);', onClick: function onClick() {
								return _this7.props.onClick('show_active');
							} },
						'Active '
					)
				);
	...
	var App = function (_Component5) {
		...
		_createClass(App, [{
			key: 'addTodoHandler',
			value: function addTodoHandler(text) {
				var state = this.state;
				var newState = Object.assign({}, state, { todoList: [].concat(_toConsumableArray(state.todoList), [{ 'title': text, 'done': false }]) });
				this.setState(newState);
			}
		}, {
			key: 'toggleTodoItem',
			value: function toggleTodoItem(index) {
				var state = this.state;
				var newState = Object.assign({}, state, { todoList: state.todoList.map(function (todoListItem, _index) {
						if (index === _index) {
			...
			key: 'filterStateHandler',
			value: function filterStateHandler() {
				var filterState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'show_all';
